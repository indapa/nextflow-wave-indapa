...
### PacBio Sequecing Data

PacBio [HiFi reads](https://www.pacb.com/technology/hifi-sequencing/how-it-works/) are highly accucrated long reads generated by circular consensus sequencing (CCS). The CCS reads are generated by sequencing the same DNA molecule multiple times, and then using the consensus of the multiple reads to generate a single high-quality read. 
